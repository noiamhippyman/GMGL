...
*/
gmgl_create_window_centered(800,600,"Example - Depth Testing");
...
*/
var vertShader = gl_create_shader(GL_VERTEX_SHADER,shader_example_depth_test_vs());
var fragShader = gl_create_shader(GL_FRAGMENT_SHADER,shader_example_depth_test_fs());
