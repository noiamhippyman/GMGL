...
*/
gmgl_create_window_centered(800,600,"Example - Basic ADS Lighting");
glfw_set_window_icon("GMGL/gmglicon.png");

gl_enable(GL_DEPTH_TEST);

var vs = gl_create_shader(GL_VERTEX_SHADER, shader_example_basic_lighting_vs());
var fs = gl_create_shader(GL_FRAGMENT_SHADER, shader_example_basic_lighting_fs());
