...
*/
gmgl_create_window_centered(800,600,"Example - Blinn Phong Lighting (Space: toggle blinn)");
...
shader = gmgl_shader_create(shader_example_advlighting_vs(), shader_example_advlighting_fs());
