...
var proj = matrix_build_projection_perspective_fov(cameraFOV,800/600,0.1,10000.0);
...
var model = matrix_build(0,0,0, t,0,0, 4,4,4);
...
gmgl_shader_set_mat4(planetShader, "projection", projMatrixBuffer);
gmgl_shader_set_mat4(planetShader, "view", viewMatrixBuffer);
gmgl_shader_set_mat4(planetShader, "model", modelMatrixBuffer);
gl_bind_vertex_array(planetVAO);
gl_draw_arrays(GL_TRIANGLES, 0, 36);

gl_use_program(asteroidShader);
gmgl_shader_set_mat4(asteroidShader, "projection", projMatrixBuffer);
gmgl_shader_set_mat4(asteroidShader, "view", viewMatrixBuffer);
gl_bind_vertex_array(asteroidVAO);
gl_draw_arrays_instanced(GL_TRIANGLES, 0, 36, asteroidAmount);
