...
gmgl_shader_set_vec3(shaderLighting, "light.position", lightPos);
gmgl_shader_set_vec3(shaderLighting, "viewPos", cameraPos);

gmgl_shader_set_vec3(shaderLighting, "light.ambient", [0.2,0.2,0.2]);
gmgl_shader_set_vec3(shaderLighting, "light.diffuse", [0.5,0.5,0.5]);
gmgl_shader_set_vec3(shaderLighting, "light.specular", [1,1,1]);

gmgl_shader_set_float(shaderLighting, "material.shininess", 64);
