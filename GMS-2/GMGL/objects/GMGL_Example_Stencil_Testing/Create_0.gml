...
*/
gmgl_create_window_centered(800,600,"Example - Stencil Testing");
...
*/
var vertShader = gl_create_shader(GL_VERTEX_SHADER,shader_example_stencil_test_vs());
var fragShader = gl_create_shader(GL_FRAGMENT_SHADER,shader_example_stencil_test_fs());
...
vertShader = gl_create_shader(GL_VERTEX_SHADER, shader_example_stencil_test_vs());
fragShader = gl_create_shader(GL_FRAGMENT_SHADER, shader_example_stencil_color_fs());
shaderColorProgram = gl_create_program();
gl_attach_shader(shaderColorProgram,vertShader);
gl_attach_shader(shaderColorProgram,fragShader);
gl_link_program(shaderColorProgram);
gl_delete_shader(vertShader);
gl_delete_shader(fragShader);
...
gl_vertex_attrib_pointer(0,3,GL_FLOAT,GMGL_FALSE,5 * buffer_sizeof(buffer_f32),0);

// Don't forget to enable the attribute also
gl_enable_vertex_attrib_array(0);

gl_vertex_attrib_pointer(1, 2, GL_FLOAT, GMGL_FALSE, 5 * buffer_sizeof(buffer_f32), 3 * buffer_sizeof(buffer_f32));
