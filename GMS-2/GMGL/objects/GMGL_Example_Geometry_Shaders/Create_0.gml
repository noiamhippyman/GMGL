...
*/
gmgl_create_window_centered(800,600,"Example - Geometry Shaders");
...
*/
var vertShader = gl_create_shader(GL_VERTEX_SHADER,shader_example_geomshader_vs());
var geomShader = gl_create_shader(GL_GEOMETRY_SHADER, shader_example_geomshader_gs());
var fragShader = gl_create_shader(GL_FRAGMENT_SHADER,shader_example_geomshader_fs());
...
gl_attach_shader(shaderProgram,geomShader);
...
gl_vertex_attrib_pointer(0,2,GL_FLOAT,GMGL_FALSE,5 * buffer_sizeof(buffer_f32),0);
gl_enable_vertex_attrib_array(1);
gl_vertex_attrib_pointer(1,3,GL_FLOAT,GMGL_FALSE,5 * buffer_sizeof(buffer_f32),2 * buffer_sizeof(buffer_f32));
