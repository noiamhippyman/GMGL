...
gmgl_create_window(scr_width,scr_height,"Demo - Using Coordinate Systems");

var vertexShader = gmgl_create_shader(GMGL_VERTEX_SHADER,vertex_shader_coordinates());
var fragmentShader = gmgl_create_shader(GMGL_FRAGMENT_SHADER,fragment_shader_coordinates());
