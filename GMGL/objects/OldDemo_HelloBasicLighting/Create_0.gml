...
var vertexShader = gmgl_create_shader(GL_VERTEX_SHADER, vertex_shader_basic_lighting());
var fragmentShader = gmgl_create_shader(GL_FRAGMENT_SHADER, fragment_shader_basic_lighting());
