...
gmgl_create_window_centered(scr_width,scr_height,"Demo - Hello cube!");

gmgl_enable(GL_DEPTH_TEST);

var vertexShader = gmgl_create_shader(GL_VERTEX_SHADER,vertex_shader_cube());
var fragmentShader = gmgl_create_shader(GL_FRAGMENT_SHADER,fragment_shader_cube());
