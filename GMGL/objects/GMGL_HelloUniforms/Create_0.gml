...
gmgl_create_window(800,600,"Demo - Using Shader Uniforms");

var vertexShader = gmgl_create_shader(GMGL_VERTEX_SHADER,vertex_shader_uniforms());
var fragmentShader = gmgl_create_shader(GMGL_FRAGMENT_SHADER,fragment_shader_uniforms());
...
colorUniform = gmgl_get_uniform_location(program,"ourColor");
