...
*/
gmgl_create_window_centered(800,600,"Example - Shader Uniforms");
...
*/
var vertShader = gl_create_shader(GL_VERTEX_SHADER,shader_example_uniforms_vs());
var fragShader = gl_create_shader(GL_FRAGMENT_SHADER,shader_example_uniforms_fs());
...
// Now lets get our uniform location for the uniform in shader_example_uniforms_fs fragment shader
ColorUniformID = gl_get_uniform_location(shaderProgram, "Color");